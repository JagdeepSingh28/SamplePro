package com.example.jagdeepsingh.samplepro.camera2.videoRecord;
...
public class Camera2Video extends AppCompatActivity implements View.OnClickListener {
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(previewSurface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                    Activity activity = Camera2Video.this;
                    if (null != activity) {
